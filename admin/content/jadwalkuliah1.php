		            ...
		            <div class="row-fluid">
		            	<div class="span6">
			            	<div class="control-group">
				                ...
				                <div class="controls hari">
				                  <select name="hari" class="form-control hari" required autofocus/>
				                    <option>Senin</option>
		            	...
		            	<div class="span6">
			                ...
			                <div class="controls">
			                  <input name="jam" type="time" class="form-control span11 jam" placeholder="" autofocus/>
			                </div>
		                </div>
	            	</div>
		            <div class="row-fluid">
