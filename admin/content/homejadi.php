                ...
                <?php 
                      ...
                      if(($jam > 0) && ($jam < 16)){
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;"><a href="javascript:;" onclick="edit('<?=$data['id_matakuliah']?>','<?=$data['matakuliah']?>');"><i class="icon-pencil" style="color:green;"></i></a> | <a href="javascript:;"><i class=  "icon-trash" style="color:red;" onclick="del('<?=$data['id_today']?>');"></i></a>
                          </td>
                        </tr> 
                        <?php } ?>
...
<script type="text/javascript">
  ...
  function edit(id, matakuliah, keterangan, ruangan){
    $("#gg").show();
    $(".id").val(id);
